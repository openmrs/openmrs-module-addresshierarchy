...
public class AddressHierarchyAjaxControllerTest extends BaseModuleContextSensitiveTest {
	...
	public void getPossibleAddressHierarchyEntries_shouldReturnEmptyMapWhenAddressFieldNameIsWrong() throws Exception {
		ArrayList<ModelMap> result = controller.getPossibleAddressHierarchyEntriesWithParents("unions ",
		    "incorrect-address-field", null, null, 10);
		assertThat(result.size(), is(equalTo(0)));
	}
	
	@Test
	public void getPossibleAddressHierarchyEntries_shouldReturnEmptyLimitForWrongLimit() throws Exception {
		ArrayList<ModelMap> result = controller.getPossibleAddressHierarchyEntriesWithParents("unions ", "cityVillage", null,
		    null, -1);
		assertThat(result.size(), is(equalTo(0)));
	}
	...
	public void getPossibleAddressHierarchyEntries_shouldHonourLimit() throws Exception {
		...
		result = controller.getPossibleAddressHierarchyEntriesWithParents("Unions ", "cityVillage",
		    "66e41146-e162-11df-9195-001e378eb67f", null, 2);
		assertThat(result.size(), is(equalTo(1)));
		
		result = controller.getPossibleAddressHierarchyEntriesWithParents("non-existent-address", "cityVillage",
		    "66e41146-e162-11df-9195-001e378eb67f", null, 1);
		assertThat(result.size(), is(equalTo(0)));
	}
	
	@Test
	public void getPossibleAddressHierarchyEntries_shouldRetrieveAddressHierarchyEntriesWhenParentNotSpecified()
	        throws Exception {
		ArrayList<ModelMap> result = controller.getPossibleAddressHierarchyEntriesWithParents("Unions ", "cityVillage", null,
		    null, 10);
	...
	@Test
	public void getPossibleAddressHierarchyEntries_shouldRetrieveAddressHierarchyEntriesWhenParentSpecified()
	        throws Exception {
		ArrayList<ModelMap> result = controller.getPossibleAddressHierarchyEntriesWithParents("Unions ", "cityVillage",
		    "66e41146-e162-11df-9195-001e378eb67f", null, 10);
		assertThat(result.size(), is(equalTo(1)));
		assertThat(result, hasItem(modelMapWithValue("name", "Unions Of Kaliganj Upazila")));
		assertThat(result, hasItem(modelMapWithValue("uuid", "88e41146-e162-11df-9195-001e378eb67f")));
	}
