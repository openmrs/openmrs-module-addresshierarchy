...
public class AddressHierarchyModuleException extends APIException {
	 ...
	 * {@link #AddressHierarchyModuleException(String)} constructor to specify a helpful message to the
	 * end user
	 */
	...
	/**
	 * Constructor used to simply chain a parent exception cause to an AddressHierarchyModuleException.
	 * Preference should be given to the {@link #AddressHierarchyModuleException(String, Throwable)}
