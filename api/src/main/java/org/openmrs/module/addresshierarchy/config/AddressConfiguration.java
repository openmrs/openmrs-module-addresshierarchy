...
public class AddressConfiguration {
	...
	public AddressTemplateCompatibility getAddressTemplate() {
		
		final AddressTemplateCompatibility addressTemplate = Context.getRegisteredComponent(AddressHierarchyConstants.COMPONENT_ADDRESS_TEMPLATE, AddressTemplateCompatibility.class);
